        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BudgetLimits_Workspaces_WorkspaceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Departments_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecurringTransactions_Users_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkspaceId = table.Column<Guid>(type: "uuid", nullable: false),
                    TriggeredAtAmount = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BudgetAlerts_BudgetLimits_BudgetLimitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkspaceMembers_Departments_DepartmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalRequests_Transactions_TransactionId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApprovalRequests_Users_ReviewerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransactionSplits_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetAlerts_BudgetLimitId",
                table: "BudgetAlerts",
                column: "BudgetLimitId");

            migrationBuilder.CreateIndex(
                name: "IX_BudgetLimits_WorkspaceId",
                table: "BudgetLimits",
                column: "WorkspaceId");

            migrationBuilder.CreateIndex(
                name: "IX_Departments_WorkspaceId",
                table: "Departments",
                column: "WorkspaceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringTransactions_OwnerId",
                table: "RecurringTransactions",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_RecurringTransactions_WorkspaceId",
                table: "RecurringTransactions",
                column: "WorkspaceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionSplits_WorkspaceId",
                table: "TransactionSplits",
                column: "WorkspaceId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkspaceMembers_DepartmentId",
